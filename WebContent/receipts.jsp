					...
					<li>
							<div class="dropdown">
							  ...
							  <div class="dropdown-content">
							    <a href="mainPage.jsp"><img src="./images/edit-profile.png" width="20px" height="20px"><span>Profile details</span></a>
	...
	<section>
		<div class="container">
				<%
					...
					String sql ="select * from smart_shopping.orders where uid="+UID+";";
					order= statement.executeQuery(sql);
					
					while(order.next())
					{
						String time=order.getString("time");
						int noItems=Integer.parseInt(order.getString("No_of_items"));
						int total=Integer.parseInt(order.getString("total"));
